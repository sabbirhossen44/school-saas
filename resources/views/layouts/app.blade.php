...
<head>
    ...
    <meta name="google-site-verification" content="LFV-RouUutRWPFg-gMevImKKdxbsp9AezTOm55b6NME" />
    <!-- Title -->
...
<body>
            ...
            <div class="w-100" style="z-index: 99; position: fixed; top: 0;">
                ...
                <div class="alert alert-primary alert-dismissible fade show mb-0 w-100 text-center rounded-0 text-black"
                    ...
                    <strong><i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="bottom"
                        ...
                        Storage link dose not exist or image not found then</strong> please run <code class="text-danger">php
                            artisan
                            storage:link</code> or <a href="#" class="btn btn-sm btn-dark">
                        Click Here</a>
    ...
    {{-- tiny mce --}}
    {{-- <script src="https://cdn.tiny.cloud/1/l4ol7axr5hc77b0yabom4yi9tskd90rjbw8zfjq0mqrw3ih4/tinymce/7/tinymce.min.js"
        referrerpolicy="origin"></script> --}}
    {{-- sortable js --}}
    <script src="{{ asset('assets/scripts/tinymce.min.js') }}"></script>
    ...
    <script>
        function sureFirstAction(submitUrl) {
            Swal.fire({
                title: "Are you sure?",
